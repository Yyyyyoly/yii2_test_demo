 ...
 */
namespace WorkermanForWindows\Protocols;
 ...
 * WebSocket protocol.
 */
class Websocket implements \WorkermanForWindows\Protocols\ProtocolInterface
{
    /**
     * Websocket blob type.
     *
     ...
     *
     * @param string                              $buffer
     * @param \WorkermanForWindows\Connection\TcpConnection $connection
     * @return int
     */
